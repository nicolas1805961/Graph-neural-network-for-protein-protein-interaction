...
#model = get_model()
model = GCN(input_dim=20, hidden_dim=hidden_dim, num_layers=num_layers)
...
train(model=model, train_dataloader=train_dataloader, val_dataloader=val_dataloader, writer=writer, epochs=epochs, validation_step=validation_step, log_dir=log_dir)